                   ...
                   <form action="{{ url('upload_doctor') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group">
                            ...
                            <input id="name" class="form-control" type="text" name="fullname" placeholder="name" value="{{ old("name") }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="room" class="form-control" type="text" name="room" placeholder="speciality" value="{{ old("speciality") }}">
                        </div>
